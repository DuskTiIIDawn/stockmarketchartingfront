            ...
            <div class="card container ">
                <form onSubmit={this.handleSubmit} action="#" >
                    ...
                    <div class="form-group row">
                        <label for="input1" class="col-4 col-md-2 col-form-label ">Company Name</label>
                    ...
                    <div class="form-group row">
                        <label for="input2" class="col-4 col-md-2  col-form-label">Turn Over</label>
                    ...
                    <div class="form-group row">
                        <label for="input3" class="col-4 col-md-2 col-form-label">CEO</label>
                        <div class="col-8 col-md-9">
                            <input type="text" class="form-control" id="input3" placeholder="CEO" name="ceo" defaultValue={this.state.company?.ceo} required />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input4" class="col-4  col-md-2 col-form-label">Board Of Directors</label>
                        <div class="col-8 col-md-9">
                    ...
                    <div class="form-group row">
                        <label for="input5" class="col-4 col-md-2 col-form-label">Company Brief</label>
                        <div class="col-8 col-md-9">
